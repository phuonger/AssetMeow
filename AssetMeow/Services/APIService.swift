...
class APIService {
    ...
    func updateLocation(id: Int, name: String) async throws -> GenericResponse {
        ...
        return try await request("locations", method: "PUT", body: body, queryParams: ["id": "\(id)"])
    }
    ...
    func updatePerson(id: Int, name: String?, role: String?) async throws -> GenericResponse {
        ...
        if let role = role { body["role"] = role }
        return try await request("people", method: "PUT", body: body, queryParams: ["id": "\(id)"])
    }
    ...
    // MARK: - Activity
    func getActivity(deviceId: Int? = nil, actionType: String? = nil, limit: Int = 200, dateFrom: String? = nil, dateTo: String? = nil, user: String? = nil) async throws -> ActivityResponse {
        ...
        if let user = user { params["user"] = user }
